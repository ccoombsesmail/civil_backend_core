...
object UsersApi {
  ...
  val getUserEndpoint: Endpoint[(String, String), ErrorInfo, OutgoingUser, Any] =
    baseEndpoint
      .get
      .in("users")
      .in(query[String]("userId"))
      .in(query[String]("requesterId"))
      .out(jsonBody[OutgoingUser])
  ...
  val updateUserBioInformationEndpoint: Endpoint[(String, UpdateUserBio), ErrorInfo, OutgoingUser, Any] =
    baseEndpoint
      .patch
      .in("users")
      .in(query[String]("userId"))
